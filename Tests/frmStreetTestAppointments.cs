...
namespace My_DVLD.Screens_People
{
    public partial class frmStreetTestAppointments : Form
    {
        ...
        public frmStreetTestAppointments(int LDLAppID,int appID)
        {
            InitializeComponent();
        ...
        {
            dataTable1 = clsStreetTestAppointments.getStreetApptInfo(_LDLAppID);
        ...
        private void btnNewStreetTestApp_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count == 0)
            {
                frmScheduleTest frm = new frmScheduleTest(_LDLAppID, frmMode.AddNewStreetAppointment);
                frm.ShowDialog();
